  ...
  return (
    <Layout>
      ...
      <section className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg text-gray-600 max-w-3xl">
            Estamos à disposição para atender suas dúvidas, fornecer orçamentos ou ajudar com informações sobre nossos produtos e serviços.
          </p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">contato@construtoraebo.com</p>
                    <p className="text-gray-600">vendas@construtoraebo.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-200 hover:bg-yellow-500 text-gray-700 hover:text-white p-3 rounded-full transition-colors">
      ...
      <section className="pb-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-6 text-center">Localização</h2>
